      ...
      u_int16_t key_size, prf_plus_t *prf_plus)
{
   ...
   DBG_WITH_ANDROID_PROPERTY("persist.net.wo.key.display", DBG_KEY, "Sk_ei secret %B", &key);
   ...
   DBG_WITH_ANDROID_PROPERTY("persist.net.wo.key.display", DBG_KEY, "Sk_er secret %B", &key);
      ...
      u_int16_t enc_size, u_int16_t int_alg, prf_plus_t *prf_plus)
{
   ...
   //	DBG4(DBG_IKE, "Sk_ai secret %B", &key);
    DBG_WITH_ANDROID_PROPERTY("persist.net.wo.key.display", DBG_KEY, "Sk_ai secret %B", &key);
   ...
   DBG_WITH_ANDROID_PROPERTY("persist.net.wo.key.display", DBG_KEY, "Sk_ar secret %B", &key);
