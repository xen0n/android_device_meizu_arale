...
ENUM_BEGIN(ikev2_integrity_algorithm_names, AUTH_UNDEFINED, AUTH_CAMELLIA_XCBC_96,
   "UNDEFINED",
   "HMAC_SHA1_128",
   ...
   "HMAC_SHA2_512_512",
   "CAMELLIA_XCBC_96");
ENUM_NEXT(ikev2_integrity_algorithm_names, AUTH_HMAC_MD5_96, AUTH_HMAC_SHA2_512_256, AUTH_CAMELLIA_XCBC_96,
   "HMAC_MD5_96 [RFC2403]",
   ...
   "AES_192_GMAC",
   "AES_256_GMAC",
   "HMAC_SHA2_256-128 [RFC4868]",
   "HMAC_SHA2_384_192 [RFC4868]",
   "HMAC_SHA2_512_256 [RFC4868]");
ENUM_END(ikev2_integrity_algorithm_names, AUTH_HMAC_SHA2_512_256);
