...
typedef enum
{
    RES_MGR_DRV_VECMPLL_CTRL_SET_HIGH,
    RES_MGR_DRV_VECMPLL_CTRL_SET_LOW
}RES_MGR_DRV_VECMPLL_CTRL_ENUM;
//-----------------------------------------------------------------------------
class ResMgrDrv
{
    protected:
    ...
    public:
        ...
        virtual MBOOL vencpllCtrl(RES_MGR_DRV_VECMPLL_CTRL_ENUM)=0;
};
//-----------------------------------------------------------------------------
#endif
