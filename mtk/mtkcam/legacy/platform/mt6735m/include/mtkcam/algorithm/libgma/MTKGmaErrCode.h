...
#ifndef _MTK_GMA_ERRCODE_H
#define _MTK_GMA_ERRCODE_H
...
#define MODULE_MTK_GMA (0) // Temp value

#define MTKGMA_OKCODE(errid)         OKCODE(MODULE_MTK_GMA, errid)
#define MTKGMA_ERRCODE(errid)        ERRCODE(MODULE_MTK_GMA, errid)


// Detection error code
#define S_GMA_OK                  MTKGMA_OKCODE(0x0000)

#define E_GMA_NEED_OVER_WRITE     MTKGMA_ERRCODE(0x0001)
#define E_GMA_NULL_OBJECT         MTKGMA_ERRCODE(0x0002)
#define E_GMA_WRONG_STATE         MTKGMA_ERRCODE(0x0003)
#define E_GMA_WRONG_CMD_ID        MTKGMA_ERRCODE(0x0004)
#define E_GMA_WRONG_CMD_PARAM     MTKGMA_ERRCODE(0x0005)
#define E_GMA_PROCESS_OVER_TIME   MTKGMA_ERRCODE(0x0006)

#define E_GMA_ERR                 MTKGMA_ERRCODE(0x0100)
