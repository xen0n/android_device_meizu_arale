...
{
    //
    eDrvScenario_VSS = 0,                //  Video shap shot
    //
    eDrvScenario_IP = 1,                 //  Image Playback (hardware scenario)
    //
    eDrvScenario_CC = 2,                 //  concurrency (N3D IC)
    //
    //eDrvScenario_CC_SShot = 3,           //  concurrency contiouous shot
    //
