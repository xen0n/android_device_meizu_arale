...
public:
    ...
    virtual MBOOL   startCQ0() = 0;
    virtual MBOOL   startCQ0B() = 0;
    //virtual MBOOL   startCQ0_D() = 0; //Mark by Ryan - No use in mt6582
    //virtual MBOOL   startCQ0B_D() = 0;  //Mark by Ryan - No use in mt6582
    virtual MBOOL   irq(EPipePass pass, EPipeIRQ irq_int, int userEnumss) = 0;
    virtual MBOOL   irq(EPipePass pass, EPipeIRQ irq_int, int irqclear, int userEnumss) = 0;
