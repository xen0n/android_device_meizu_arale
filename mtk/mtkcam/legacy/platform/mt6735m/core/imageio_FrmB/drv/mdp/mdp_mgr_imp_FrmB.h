...
#define DPSTREAM_NUM ((NSImageio_FrmB::NSIspio_FrmB::eScenarioID_CONFIG_FMT))
...
typedef struct
{
    MDPMGR_OUTPORT_INDEX_FRMB  mdpOutputIdx;
...
*/
class MdpMgrImp_FrmB : public MdpMgr_FrmB
{
    public :
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 startMdp(MDPMGR_CFG_STRUCT_FRMB cfgData);
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 stopMdp(MDPMGR_CFG_STRUCT_FRMB cfgData);
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 dequeueBuf(MDPMGR_DEQUEUE_INDEX_FRMB deqIndex, MDPMGR_CFG_STRUCT_FRMB cfgData);
        ...
        /**
               ...
               *-MTRUE indicates success, otherwise indicates fail
             */
        virtual MINT32 dequeueFrameEnd(MDPMGR_CFG_STRUCT_FRMB cfgData);
