...
#ifndef _CDP_DRV_FRMB_H_
#define _CDP_DRV_FRMB_H_

#include "imageio_types.h"
#include <mtkcam/drv_FrmB/isp_drv_FrmB.h>    // for IspDrv class.
#include <mtkcam/drv_common/isp_reg.h>    // For isp_reg_t.
...
typedef enum
{
    ...
    CDP_DRV_FORMAT_RAW8,    // only for imgo output
    CDP_DRV_FORMAT_RAW10,   // only for imgo output
    CDP_DRV_FORMAT_RAW12    // only for imgo output
} CDP_DRV_FORMAT_ENUM;
...
class CdpDrv
{
    ...
    public:
        ...
        /**
             ...
             *-MTRUE indicates success, otherwise indicates failure
             */
        virtual MBOOL SetIspDrv(IspDrv *pPhyIspDrv) = 0;
