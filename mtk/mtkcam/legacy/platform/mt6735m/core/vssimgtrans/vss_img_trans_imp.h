...
//----------------------------------------------------------------------------
#define LOG_MSG(fmt, arg...)    ALOGD("(%d)[%s]"          fmt, ::gettid(), __FUNCTION__,           ##arg)
#define LOG_WRN(fmt, arg...)    ALOGW("(%d)[%s]WRN(%5d):" fmt, ::gettid(), __FUNCTION__, __LINE__, ##arg)
#define LOG_ERR(fmt, arg...)    ALOGE("(%d)[%s]ERR(%5d):" fmt, ::gettid(), __FUNCTION__, __LINE__, ##arg)
#define LOG_DMP(fmt, arg...)    ALOGE("(%d)"              fmt, ::gettid()                          ##arg)
//----------------------------------------------------------------------------
