...
protected:  ////                    Attributes.
    ...
    bool                            mCancelCapture;     //  flag for cancelCapture.
    mutable  android::Mutex         mModuleMtx;

public:     ////                    Attributes.
    inline bool                     getCancelCapture() const
                                    {
                                        android::Mutex::Autolock _l(mModuleMtx);
                                        return mCancelCapture;
                                    }
