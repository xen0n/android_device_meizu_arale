...
namespace NSACDK
{
    ...
    public:
        ...
        /**
                *@brief Start preview
                *
                *@param[in] scenario : scenario to start preview
                *
                *@return
                *-0 indicates success, otherwise indicates fail
              */
        virtual MINT32 startPreview(MUINT16 scenario);
    ...
    private:
       ...
       // SensorHal *m_pSensorHalObj;
        ...
        IHalSensorList*m_pSensorListObj;
        MBOOL   mSensorInit;
        MUINT32 mu4SensorDelay;
        MINT32  mSupportedSensorDev;
        MINT32  mSensorDev;
        MINT32  mSensorType;
        //MUINT32 mSensorBitDepth;
...
//        halSensorRawImageInfo_t mSensorFormatInfo;  // Although name is RawImageInfo, but can get both raw/yuv type
        ...
        SensorStaticInfo sensorStaticInfo[2];
