...
#ifndef _ISPDRV_MGR_V3_H_
#define _ISPDRV_MGR_V3_H_
...
public:     ////    Interfaces.
     ...
     */
    virtual void*           getIspReg() const = 0;
     ...
     */
    virtual MBOOL           readRegs(ISPREG_INFO_T*const pRegInfos, MUINT32 const count) = 0;
     ...
     * @param [in] count register count
     */
    virtual MBOOL           writeRegs(ISPREG_INFO_T*const pRegInfos, MUINT32 const count) = 0;
