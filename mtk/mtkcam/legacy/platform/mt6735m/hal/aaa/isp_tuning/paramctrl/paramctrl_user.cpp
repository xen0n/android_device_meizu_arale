...
setIspUserIdx_Edge(EIndex_Isp_Edge_T const eIndex)
{
    ...
    MY_LOG_IF(m_bDebugEnable, "[+setIspUserIdx_Edge] (old, new)=(%d, %d)", m_rIspCamInfo.rIspUsrSelectLevel.eIdx_Edge, eIndex);
...
setIspUserIdx_Hue(EIndex_Isp_Hue_T const eIndex)
{
    ...
    MY_LOG_IF(m_bDebugEnable, "[+setIspUserIdx_Hue] (old, new)=(%d, %d)", m_rIspCamInfo.rIspUsrSelectLevel.eIdx_Hue, eIndex);
...
setIspUserIdx_Sat(EIndex_Isp_Saturation_T const eIndex)
{
    ...
    MY_LOG_IF(m_bDebugEnable, "[+setIspUserIdx_Sat] (old, new)=(%d, %d)", m_rIspCamInfo.rIspUsrSelectLevel.eIdx_Sat, eIndex);
...
setIspUserIdx_Bright(EIndex_Isp_Brightness_T const eIndex)
{
    ...
    MY_LOG_IF(m_bDebugEnable, "[+setIspUserIdx_Bright] (old, new)=(%d, %d)", m_rIspCamInfo.rIspUsrSelectLevel.eIdx_Bright, eIndex);
...
setIspUserIdx_Contrast(EIndex_Isp_Contrast_T const eIndex)
{
    ...
    MY_LOG_IF(m_bDebugEnable, "[+setIspUserIdx_Contrast] (old, new)=(%d, %d)", m_rIspCamInfo.rIspUsrSelectLevel.eIdx_Contrast, eIndex);
