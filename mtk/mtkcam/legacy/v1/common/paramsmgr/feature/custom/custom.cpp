...
#define SCENE_AS_DEFAULT_PICTURE_SIZE_SCENE(_macro_item_default_, _macro_item_max_, _macro_extra_item_list_)         \
    ...
    addExtraPictureSizes(szDefaultScene_PictureSizes, picSizesCnt, szDefaultScene_ExtraItemList, extraItemListSize);  \
...
#define SCENE_AS_DEFAULT_PREVIEW_SIZE_SCENE(_macro_item_default_, _macro_item_max_, _macro_extra_item_list_)         \
    ...
    addExtraPreviewSizes(szDefaultScene_PrvSizes, prvSizesCnt, szDefaultScene_ExtraItemList, extraItemListSize);  \
