...
#define CAM_LOGV(fmt, arg...)       ALOGV("\r\n" fmt, ##arg)
#define CAM_LOGD(fmt, arg...)       ALOGD("\r\n" fmt, ##arg)
#define CAM_LOGI(fmt, arg...)       ALOGI("\r\n" fmt, ##arg)
#define CAM_LOGW(fmt, arg...)       ALOGW("\r\n" fmt, ##arg)
#define CAM_LOGE(fmt, arg...)       ALOGE(" (%s){#%d:%s}""\r\n" fmt, __FUNCTION__, __LINE__, __FILE__, ##arg)
//
#else
//
#include <cutils/log.h>
